...
import com.panda.html2word.bean.SegmentData;
import com.panda.html2word.bean.StoryData;
import com.panda.html2word.utils.Html2Word;
...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            s1.setPicture(new PictureRenderData(510, 402, "src/main/resources/story/image1.jpeg"));
            segments.add(s1);
            ...
            s2.setPicture(new PictureRenderData(510, 510, "src/main/resources/story/image2.jpeg"));
            segments.add(s2);
            ...
            DocxRenderData segment = new DocxRenderData(new File("src/main/resources/story/segment.docx"), segments);
            data.setSegment(segment);
            //html转word思路
            convert = Html2Word.convert("<table border=\"1\">" +
                    "<tr>" +
                    "<td>row 1, cell 1</td>" +
                    "<td>row 1, cell 2</td>" +
                    "</tr>" +
                    ...
                    "</table>");
            //html内容
            data.setHtml(new DocxRenderData(convert));
            XWPFTemplate template = XWPFTemplate.compile("src/main/resources/story/story.docx").render(data);
